...
public class ShareDetails {
    ...
    public ShareDetails(float price, float beta, long volAvg, String mktCap, float lastDiv, String range, float changes, String changesPercentage, String companyName, String exchange, String industry, String website, String description, String ceo, String sector, String image) {
        this.price = price;
        this.beta = beta;
        this.volAvg = volAvg;
        this.mktCap = mktCap;
