...
public class ShareInformationViewModel extends BaseViewModel {
    private float price;
    private float beta;
    private long volAvg;
    ...
    public ShareInformationViewModel() {
    }

    public ShareInformationViewModel(float price, float beta, long volAvg, String mktCap, float lastDiv, String range, float changes, String changesPercentage, String companyName, String exchange, String industry, String website, String description, String ceo, String sector, String image) {
        super("Share", "Share information page");
        this.price = price;
        this.beta = beta;
        this.volAvg = volAvg;
        this.mktCap = mktCap;
