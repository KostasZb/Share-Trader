...
<head>
    <meta charset="utf-8">
    <title>${newsList.pageTitle}</title>
...
<div class="container">
    ...
    <div class="row">
        <div class="col-md-12 text-center p-2">
            ...
            <h2>View news about shares you are interested in</h2>
            <div class="container">
                <div class="row">
                    <c:forEach var="news" items="${newsList.data}">
                        <div class="col-sm-6">
                            <a href="${news.news_url}" target="_blank" class="text-dark btn">
                                <div class="card">
                                    <img class="card-img-top" src="${news.image_url}" alt="news image">
                                    <div class="card-body">
                                        <h4 class="card-title">${news.title}</h4>
                                        <p class="card-text">${news.text}</p>
                                        <p class="card-text">Source: ${news.source_name}</p>
